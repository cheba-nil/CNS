...
function NBTR_1_seg (imgFolder, spm12path)
    ...
    parfor i = 1:Nsubj
     ...
     movefile (strcat (imgFolder, '/c*'), strcat (imgFolder, '/spmoutput'), 'f');
     movefile (strcat (imgFolder, '/rc*'), strcat (imgFolder, '/spmoutput'), 'f');
     movefile (strcat (imgFolder, '/*.mat'), strcat (imgFolder, '/spmoutput'), 'f');
