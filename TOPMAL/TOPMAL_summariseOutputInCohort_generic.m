function TOPMAL_summariseOutputInCohort_generic (studyFolder, DARles_folder, atlasCode, atlasProbThr, varargin)
...
for i = 1:Nsubj
    DARlesImgNames = strsplit (DARles_list(i).name, '_');
    ID = DARlesImgNames{1};   % first section is ID
