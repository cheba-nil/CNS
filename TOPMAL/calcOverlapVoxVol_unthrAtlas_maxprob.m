function Nvoxs_Vol_onAtlas = calcOverlapVoxVol_unthrAtlas_maxprob (DARTEL_lesionMask, DARTEL_atlas, atlasCode, lesionOnAtlasImgOutput)
...
for i = 1:atlasNvol
    Nvoxs_Vol_onAtlas (i, 1) = sum (rem (...
    										DARTEL_lesionOnAtlas_3Ddata (DARTEL_lesionOnAtlas_3Ddata > i & DARTEL_lesionOnAtlas_3Ddata < (i + 1)), ...
    										floor (...
                                                    DARTEL_lesionOnAtlas_3Ddata (DARTEL_lesionOnAtlas_3Ddata > i & DARTEL_lesionOnAtlas_3Ddata < (i + 1))...
                                                  )...
    									)...
