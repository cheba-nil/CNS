...
function generate(obj);
    ...
    CNSP_reverse_registration_wMx(flair,t1,wbrain_mask);
    CNSP_reverse_registration_wMx(flair,t1,wgm_prob,'Tri');
    CNSP_reverse_registration_wMx(flair,t1,wwm_prob,'Tri');
    CNSP_reverse_registration_wMx(flair,t1,wcsf_prob,'Tri');
    CNSP_reverse_registration_wMx(flair,t1,wventricles,'Tri');
    CNSP_reverse_registration_wMx(flair,t1,wlobar);
    CNSP_reverse_registration_wMx(flair,t1,warterial);
