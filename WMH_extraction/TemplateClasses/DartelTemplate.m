    ...
    methods
        function template = DartelTemplate(CNS_path, age_range, studyFolder);
            ...
            template.brain_mask = strcat( ...
                    ...
                    age_range, '/DARTEL_brain_mask.nii');

            template.gm_prob = strcat( ...
                    CNS_path,'/Templates/DARTEL_GM_WM_CSF_prob_maps/', ...
                    age_range,'/DARTEL_GM_prob_map.nii');
            template.wm_prob = strcat( ...
                    CNS_path,'/Templates/DARTEL_GM_WM_CSF_prob_maps/', ...
                    age_range,'/DARTEL_WM_prob_map.nii');
            template.csf_prob = strcat( ...
                    CNS_path,'/Templates/DARTEL_GM_WM_CSF_prob_maps/', ...
                    age_range,'/DARTEL_CSF_prob_map.nii');

            template.gm_prob_thr = strcat( ...
                    CNS_path,'/Templates/DARTEL_GM_WM_CSF_prob_maps/', ...
                    age_range,'/DARTEL_GM_prob_map_thr0_8.nii');
            template.wm_prob_thr = strcat( ...
                    CNS_path,'/Templates/DARTEL_GM_WM_CSF_prob_maps/', ...
                    age_range,'/DARTEL_WM_prob_map_thr0_8.nii');
            ...
            template.lobar = strcat( ...
                    CNS_path,'/Templates/DARTEL_lobar_and_arterial_templates/', ...
                        'DARTEL_lobar_template.nii');
            template.arterial = strcat( ...
                    CNS_path,'/Templates/DARTEL_lobar_and_arterial_templates/', ...
                        'DARTEL_arterial_template.nii');
