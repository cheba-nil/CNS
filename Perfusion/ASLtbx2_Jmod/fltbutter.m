function [num, den, z, p] = fltbutter(n, Wn, varargin)
...
[btype,analog,errStr] = fltiirchk(Wn,varargin{:});
error(errStr)
...
if btype == 1		% Lowpass
	[a,b,c,d] = fltlp2lp(a,b,c,d,Wn);

elseif btype == 2	% Bandpass
	[a,b,c,d] = fltlp2bp(a,b,c,d,Wn,Bw);

elseif btype == 3	% Highpass
	[a,b,c,d] = fltlp2hp(a,b,c,d,Wn);

elseif btype == 4	% Bandstop
	[a,b,c,d] = fltlp2bs(a,b,c,d,Wn,Bw);
end

% step 5: Use Bilinear transformation to find discrete equivalent:
if ~analog,
	[a,b,c,d] = fltbilinear(a,b,c,d,fs);
end
