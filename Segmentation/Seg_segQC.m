...
function Seg_segQC (imgFolder, CNSP_path)

    cmd_1 = ['chmod +x ' CNSP_path '/Segmentation/generateQCimgs.sh'];
    system (cmd_1);
    ...
    for i = 1:Nsubj
        ...
        cmd = [CNSP_path '/Segmentation/generateQCimgs.sh ' ID ' ' imgFolder ' ' imgFilename];
        system (cmd);
    end
